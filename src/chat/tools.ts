          ...
          metafields: {
            ...
            items: {
              ...
              properties: {
                ...
                type: { 
                  type: 'string', 
                  description: 'Field type: text, textarea, rich-text, html-textarea, markdown, number, date, file, object, objects, switch, select, multi-select, select-dropdown, radio-buttons, repeater. Prefer rich-text for new long-form content (markdown plus optional {{name /}} block tokens for existing bucket blocks and inline object embeds {{object type="..." id="..." slug="..." /}} for existing objects); html-textarea is deprecated. Prefer select over select-dropdown for new content models.' 
                },
